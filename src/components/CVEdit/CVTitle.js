...
function CVTitle() {
  return (
    <div className="sticky -mx-6 flex items-center justify-between bg-white px-9 py-6 shadow-sm lg:static lg:mx-0 lg:rounded-2xl xl:px-16">
      ...
      <button className="flex  gap-2 rounded-full bg-sky-500 sm:px-5 p-3 sm:py-2 text-sm font-semibold leading-5 text-white hover:bg-sky-700">
